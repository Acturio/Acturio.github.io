...
En la tabla anterior la asignación de tratamiento y el resultado observado reflejan una asignación aleatoria idealizada. Caracterizamos la asignación aleatoria como idealizada porque parece haber conducido a distribuciones perfectamente equilibradas de resultados potenciales. En este caso, dado el equilibrio perfecto entre los grupos, tiene sentido que una simple diferencia en medias recupere exactamente el verdadero efecto del tratamiento de −7,5. De manera equivalente, el efecto causal promedio del tratamiento corresponde al coeficiente $\tau$ en la regresión, $y_i = \alpha + \tau z_i + error_i$, por lo que podemos estimar el efecto del tratamiento usando una regresión del resultado en la asignación del tratamiento.
...
knitr::include_graphics("img/Eficiente e insesgado.jpeg")
```
